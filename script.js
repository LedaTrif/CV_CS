const translations = {
  en: {
    ...
    seeAI: "See how I use AI", downloadCV: "Download CV (PDF)", years: "years in support & travel", cases: "cases handled daily", languages: "working languages",
  ...
  es: {
    ...
    seeAI: "Cómo uso la IA", downloadCV: "Descargar CV en inglés (PDF)", years: "años en soporte y turismo", cases: "casos gestionados al día", languages: "idiomas de trabajo",
